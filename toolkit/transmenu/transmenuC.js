 ...
 * ============================================================================================== */
TransMenu.spacerGif="toolkit/x.gif";TransMenu.dingbatOn="toolkit/arrow.gif";TransMenu.dingbatOff="toolkit/arrow.gif";TransMenu.dingbatSize=9;TransMenu.menuPadding=5;TransMenu.itemPadding=2;TransMenu.shadowSize=2;TransMenu.shadowOffset=3;TransMenu.shadowColor="#888";TransMenu.shadowPng="toolkit/grey-40.png";TransMenu.backgroundColor="#37588A";TransMenu.backgroundPng="toolkit/white-90.png";TransMenu.hideDelay=1000;TransMenu.slideTime=400;TransMenu.reference={topLeft:1,topRight:2,bottomLeft:3,bottomRight:4};TransMenu.direction={down:1,right:2};TransMenu.registry=[];TransMenu._maxZ=100;TransMenu.isSupported=function(){var ua=navigator.userAgent.toLowerCase();var pf=navigator.platform.toLowerCase();var an=navigator.appName;var r=false;if(ua.indexOf("gecko")>-1&&navigator.productSub>=20020605)r=true;else if(an=="Microsoft Internet Explorer"){if(document.getElementById){if(pf.indexOf("mac")==0){r=/msie (\d(.\d*)?)/.test(ua)&&Number(RegExp.$1)>=5.1;}
else r=true;}}
return r;}
