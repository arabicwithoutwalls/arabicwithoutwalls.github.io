	 ...
	 function checkQuiz (quizNum)
	 {
	 	switch (quizNum)
		{
			case 1:
				...
				questionsnew[0] = new Array("ng","How is the weather in Jordan during the spring?","en","Moderate","en","");
				questionsnew[1] = new Array("ng","During which months is the weather is the weather hot in Jordan?","en","حار في الصيف و خاصة في الشهر السابع و في الشهر الثامن أيضا","ar","");
				questionsnew[2] = new Array("ng","What is spring like in Ann Arbor according to Khalid?","en","أما الطقس في أن أربور، فبارد جدا في فصل الشتاء و أيضا بارد في فصل الربي","ar","");
				questionsnew[3] = new Array("ng","How is the weather in Ann Arbor during September and October (Hint: in the 9th and 10th months)?","en","و الطقس في الشهر التاسع و العاشر معتدل، و يميل الى البرودة بشكل عام","ar","");
