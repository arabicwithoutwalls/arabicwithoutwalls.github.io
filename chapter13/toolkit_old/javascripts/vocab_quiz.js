...
function load_quiz(number_of_items,shuffle_items) {
  ...
  for (var i=0;i<number_of_items;i++) {
    ...
    output = output + word[1] + ' <img src="blank.gif" alt="Feedback Image"><select name="q'+i+'"><option value="blank">--</option>';
  ...
  output = output + '\r\n</ol><br /><input type="button" value="Check Answers" onclick="checkAnswers(this.form);" /></form>';
